$(document).ready(function() {
    ...
    map.addMarker({
        ...
        infoWindow: {
            content: '<div class="note">Ceremony</div><h4 class="map-title script">Beebs Church</h4><div class="address"><span class="region">Address line goes here</span><br><span class="postal-code">Postcode</span><br><span class="city-name">City</span></div>'
        }
    ...
    map.addMarker({
        ...
        infoWindow: {
            content: '<div class="note">Reception</div><h4 class="map-title script">Party House</h4><div class="address"><span class="region">Address line goes here</span><br><span class="postal-code">Postcode</span><br><span class="city-name">City</span></div>'
        } 
